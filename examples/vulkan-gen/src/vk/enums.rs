...
impl fmt::Display for StructureType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match *self {
            ...
            Self::NATIVE_BUFFER_ANDROID => write!(f, "NATIVE_BUFFER_ANDROID"),
            Self::SWAPCHAIN_IMAGE_CREATE_INFO_ANDROID => {
                write!(f, "SWAPCHAIN_IMAGE_CREATE_INFO_ANDROID")
            }
            Self::PHYSICAL_DEVICE_PRESENTATION_PROPERTIES_ANDROID => {
                write!(f, "PHYSICAL_DEVICE_PRESENTATION_PROPERTIES_ANDROID")
            }
            ...
            Self::NATIVE_BUFFER_OHOS => write!(f, "NATIVE_BUFFER_OHOS"),
            Self::SWAPCHAIN_IMAGE_CREATE_INFO_OHOS => write!(f, "SWAPCHAIN_IMAGE_CREATE_INFO_OHOS"),
            Self::PHYSICAL_DEVICE_PRESENTATION_PROPERTIES_OHOS => {
                write!(f, "PHYSICAL_DEVICE_PRESENTATION_PROPERTIES_OHOS")
            }
...
impl RenderPassCreateFlags {
    pub const RESERVED_3_IMG: Self = Self(0x8);
...
impl InstanceCreateFlags {
    ...
    pub const RESERVED_616_EXT: Self = Self(0x2);
}
impl fmt::Display for InstanceCreateFlags {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        const BITS: &[(u64, &str)] = &[
            (1u64, "ENUMERATE_PORTABILITY_KHR"),
            (2u64, "RESERVED_616_EXT"),
        ];
        flag_display(self.0 as u64, BITS, f)
    }
}
...
impl DeviceQueueCreateFlags {
    ...
    pub const RESERVED_1_QCOM: Self = Self(0x2);
...
impl fmt::Display for DeviceQueueCreateFlags {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        const BITS: &[(u64, &str)] = &[
            (1u64, "PROTECTED"),
            (2u64, "RESERVED_1_QCOM"),
            (4u64, "INTERNALLY_SYNCHRONIZED_KHR"),
        ];
        flag_display(self.0 as u64, BITS, f)
    }
}
...
impl QueueFlags {
    ...
    pub const RESERVED_7_QCOM: Self = Self(0x80);
    pub const OPTICAL_FLOW_NV: Self = Self(0x100);
    pub const DATA_GRAPH_ARM: Self = Self(0x400);
    pub const RESERVED_12_EXT: Self = Self(0x1000);
    pub const RESERVED_9_EXT: Self = Self(0x200);
    pub const RESERVED_13_EXT: Self = Self(0x2000);
    pub const RESERVED_11_ARM: Self = Self(0x800);
}
impl fmt::Display for QueueFlags {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        const BITS: &[(u64, &str)] = &[
            ...
            (128u64, "RESERVED_7_QCOM"),
            (256u64, "OPTICAL_FLOW_NV"),
            (1024u64, "DATA_GRAPH_ARM"),
            (4096u64, "RESERVED_12_EXT"),
            (512u64, "RESERVED_9_EXT"),
            (8192u64, "RESERVED_13_EXT"),
            (2048u64, "RESERVED_11_ARM"),
        ];
        flag_display(self.0 as u64, BITS, f)
    }
}
...
impl BufferCreateFlags {
    ...
    pub const RESERVED_7_IMG: Self = Self(0x80);
...
impl ShaderStageFlags {
    ...
    pub const RESERVED_16_HUAWEI: Self = Self(0x10000);
}
impl fmt::Display for ShaderStageFlags {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        const BITS: &[(u64, &str)] = &[
            ...
            (32768u64, "RESERVED_15_NV"),
            (65536u64, "RESERVED_16_HUAWEI"),
        ];
        flag_display(self.0 as u64, BITS, f)
    }
}
...
impl ImageUsageFlags {
    ...
    pub const RESERVED_24_COREAVI: Self = Self(0x1000000);
    pub const TENSOR_ALIASING_ARM: Self = Self(0x800000);
    pub const RESERVED_28_EXT: Self = Self(0x10000000);
    pub const TILE_MEMORY_QCOM: Self = Self(0x8000000);
    ...
    pub const RESERVED_16_HUAWEI: Self = Self(0x10000);
    pub const RESERVED_27_HUAWEI: Self = Self(0x20000);
}
impl fmt::Display for ImageUsageFlags {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        const BITS: &[(u64, &str)] = &[
            ...
            (16777216u64, "RESERVED_24_COREAVI"),
            (8388608u64, "TENSOR_ALIASING_ARM"),
            (268435456u64, "RESERVED_28_EXT"),
            (134217728u64, "TILE_MEMORY_QCOM"),
            (33554432u64, "VIDEO_ENCODE_QUANTIZATION_DELTA_MAP_KHR"),
            (67108864u64, "VIDEO_ENCODE_EMPHASIS_MAP_KHR"),
            (536870912u64, "RESERVED_29_KHR"),
            (1073741824u64, "RESERVED_30_KHR"),
            (65536u64, "RESERVED_16_HUAWEI"),
            (131072u64, "RESERVED_27_HUAWEI"),
        ];
        flag_display(self.0 as u64, BITS, f)
    }
}
...
impl ImageCreateFlags {
    ...
    pub const RESERVED_21_IMG: Self = Self(0x200000);
    ...
    pub const RESERVED_22_KHR: Self = Self(0x400000);
}
...
impl CommandPoolResetFlags {
    ...
    pub const RESERVED_1_COREAVI: Self = Self(0x2);
}
impl fmt::Display for CommandPoolResetFlags {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        const BITS: &[(u64, &str)] = &[(1u64, "RELEASE_RESOURCES"), (2u64, "RESERVED_1_COREAVI")];
        flag_display(self.0 as u64, BITS, f)
    }
}
...
impl CommandBufferUsageFlags {
    ...
    pub const RESERVED_3_HUAWEI: Self = Self(0x8);
    pub const RESERVED_4_HUAWEI: Self = Self(0x10);
}
impl fmt::Display for CommandBufferUsageFlags {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        const BITS: &[(u64, &str)] = &[
            ...
            (8u64, "RESERVED_3_HUAWEI"),
            (16u64, "RESERVED_4_HUAWEI"),
        ];
        flag_display(self.0 as u64, BITS, f)
    }
}
...
impl ImageAspectFlags {
    ...
    pub const RESERVED_11_HUAWEI: Self = Self(0x800);
}
...
impl DependencyFlags {
    ...
    pub const EXTENSION_586_IMG: Self = Self(0x10);
}
...
impl fmt::Display for PrivateDataSlotCreateFlags {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        const BITS: &[(u64, &str)] = &[(1u64, "RESERVED_0_NV")];
        flag_display(self.0 as u64, BITS, f)
    }
}
...
impl AccessFlags2 {
    ...
    pub const RESERVED_46_INTEL: Self = Self(0x400000000000);
    ...
    pub const RESERVED_62_EXT: Self = Self(0x4000000000000000);
    pub const RESERVED_63_EXT: Self = Self(0x8000000000000000);
    pub const RESERVED_60_KHR: Self = Self(0x1000000000000000);
    pub const RESERVED_61_KHR: Self = Self(0x2000000000000000);
    pub const RESERVED_49_ARM: Self = Self(0x2000000000000);
    pub const RESERVED_50_ARM: Self = Self(0x4000000000000);
}
impl fmt::Display for AccessFlags2 {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        const BITS: &[(u64, &str)] = &[
            ...
            (70368744177664u64, "RESERVED_46_INTEL"),
            ...
            (4611686018427387904u64, "RESERVED_62_EXT"),
            (9223372036854775808u64, "RESERVED_63_EXT"),
            (1152921504606846976u64, "RESERVED_60_KHR"),
            (2305843009213693952u64, "RESERVED_61_KHR"),
            (562949953421312u64, "RESERVED_49_ARM"),
            (1125899906842624u64, "RESERVED_50_ARM"),
        ];
...
impl PipelineStageFlags2 {
    ...
    pub const RESERVED_49_EXT: Self = Self(0x2000000000000);
    pub const RESERVED_47_KHR: Self = Self(0x800000000000);
    pub const RESERVED_43_ARM: Self = Self(0x80000000000);
    pub const RESERVED_48_HUAWEI: Self = Self(0x1000000000000);
}
impl fmt::Display for PipelineStageFlags2 {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        const BITS: &[(u64, &str)] = &[
            ...
            (562949953421312u64, "RESERVED_49_EXT"),
            (140737488355328u64, "RESERVED_47_KHR"),
            (8796093022208u64, "RESERVED_43_ARM"),
            (281474976710656u64, "RESERVED_48_HUAWEI"),
        ];
        flag_display(self.0, BITS, f)
    }
}
...
impl FormatFeatureFlags2 {
    ...
    pub const VIDEO_ENCODE_INPUT_KHR: Self = Self(0x8000000);
    pub const VIDEO_ENCODE_DPB_KHR: Self = Self(0x10000000);
    pub const RESERVED_44_QCOM: Self = Self(0x100000000000);
    ...
    pub const RESERVED_60_EXT: Self = Self(0x1000000000000000);
    ...
    pub const RESERVED_47_ARM: Self = Self(0x800000000000);
    pub const RESERVED_61_HUAWEI: Self = Self(0x2000000000000000);
}
impl fmt::Display for FormatFeatureFlags2 {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        const BITS: &[(u64, &str)] = &[
            ...
            (134217728u64, "VIDEO_ENCODE_INPUT_KHR"),
            (268435456u64, "VIDEO_ENCODE_DPB_KHR"),
            (17592186044416u64, "RESERVED_44_QCOM"),
            (
                2251799813685248u64,
            ...
            (1152921504606846976u64, "RESERVED_60_EXT"),
            ...
            (140737488355328u64, "RESERVED_47_ARM"),
            (2305843009213693952u64, "RESERVED_61_HUAWEI"),
        ];
        flag_display(self.0, BITS, f)
    }
}
...
impl RenderingFlags {
    ...
    pub const RESERVED_9_IMG: Self = Self(0x200);
    ...
    pub const RESERVED_10_VALVE: Self = Self(0x400);
    pub const RESERVED_11_VALVE: Self = Self(0x800);
    pub const RESERVED_12_VALVE: Self = Self(0x1000);
}
impl fmt::Display for RenderingFlags {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        const BITS: &[(u64, &str)] = &[
            ...
            (1024u64, "RESERVED_10_VALVE"),
            (2048u64, "RESERVED_11_VALVE"),
            (4096u64, "RESERVED_12_VALVE"),
        ];
        flag_display(self.0 as u64, BITS, f)
    }
}
...
impl PipelineCreateFlags2 {
    ...
    pub const NO_PROTECTED_ACCESS: Self = Self(0x8000000);
    pub const PROTECTED_ACCESS_ONLY: Self = Self(0x40000000);
    pub const RESERVED_46_IMG: Self = Self(0x400000000000);
    pub const EXECUTION_GRAPH_AMDX: Self = Self(0x100000000);
    pub const DESCRIPTOR_HEAP_EXT: Self = Self(0x1000000000);
    pub const PIPELINE_CREATE_RESERVED_44_KHR: Self = Self(0x100000000000);
    ...
    pub const RESERVED_35_KHR: Self = Self(0x800000000);
    pub const PER_LAYER_FRAGMENT_DENSITY_VALVE: Self = Self(0x10000000000);
    pub const RESERVED_41_KHR: Self = Self(0x20000000000);
    pub const TYPE_64_INDEXING_EXT: Self = Self(0x80000000000);
    pub const RESERVED_45_EXT: Self = Self(0x200000000000);
    pub const RESERVED_47_AMD: Self = Self(0x800000000000);
    pub const RESERVED_48_HUAWEI: Self = Self(0x1000000000000);
}
impl fmt::Display for PipelineCreateFlags2 {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        const BITS: &[(u64, &str)] = &[
            ...
            (134217728u64, "NO_PROTECTED_ACCESS"),
            (1073741824u64, "PROTECTED_ACCESS_ONLY"),
            (70368744177664u64, "RESERVED_46_IMG"),
            (4294967296u64, "EXECUTION_GRAPH_AMDX"),
            (68719476736u64, "DESCRIPTOR_HEAP_EXT"),
            (17592186044416u64, "PIPELINE_CREATE_RESERVED_44_KHR"),
            (
                8589934592u64,
            ...
            (34359738368u64, "RESERVED_35_KHR"),
            (1099511627776u64, "PER_LAYER_FRAGMENT_DENSITY_VALVE"),
            (2199023255552u64, "RESERVED_41_KHR"),
            (8796093022208u64, "TYPE_64_INDEXING_EXT"),
            (35184372088832u64, "RESERVED_45_EXT"),
            (140737488355328u64, "RESERVED_47_AMD"),
            (281474976710656u64, "RESERVED_48_HUAWEI"),
        ];
        flag_display(self.0, BITS, f)
    }
...
impl BufferUsageFlags2 {
    ...
    pub const RESERVED_34_EXT: Self = Self(0x400000000);
    pub const TILE_MEMORY_QCOM: Self = Self(0x8000000);
    pub const MEMORY_DECOMPRESSION_EXT: Self = Self(0x100000000);
    pub const PREPROCESS_BUFFER_EXT: Self = Self(0x80000000);
    pub const RESERVED_35_KHR: Self = Self(0x800000000);
    pub const RESERVED_36_KHR: Self = Self(0x1000000000);
    pub const RESERVED_37_HUAWEI: Self = Self(0x2000000000);
}
impl fmt::Display for BufferUsageFlags2 {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        const BITS: &[(u64, &str)] = &[
            ...
            (17179869184u64, "RESERVED_34_EXT"),
            (134217728u64, "TILE_MEMORY_QCOM"),
            (4294967296u64, "MEMORY_DECOMPRESSION_EXT"),
            (2147483648u64, "PREPROCESS_BUFFER_EXT"),
            (34359738368u64, "RESERVED_35_KHR"),
            (68719476736u64, "RESERVED_36_KHR"),
            (137438953472u64, "RESERVED_37_HUAWEI"),
        ];
        flag_display(self.0, BITS, f)
    }
}
...
impl SwapchainCreateFlagsKHR {
    ...
    pub const RESERVED_5_EXT: Self = Self(0x20);
    pub const RESERVED_4_EXT: Self = Self(0x10);
...
impl WaylandSurfaceCreateFlagsKHR {
    pub const DISABLE_COLOR_MANAGEMENT: Self = Self(0x1);
}
impl fmt::Display for WaylandSurfaceCreateFlagsKHR {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        const BITS: &[(u64, &str)] = &[(1u64, "DISABLE_COLOR_MANAGEMENT")];
        flag_display(self.0 as u64, BITS, f)
    }
}
...
impl ShaderCreateFlagsEXT {
    ...
    pub const RESERVED_17_IMG: Self = Self(0x20000);
    ...
    pub const RESERVED_18_KHR: Self = Self(0x40000);
}
impl fmt::Display for ShaderCreateFlagsEXT {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        const BITS: &[(u64, &str)] = &[
            (1u64, "LINK_STAGE_EXT"),
            (131072u64, "RESERVED_17_IMG"),
            (1024u64, "DESCRIPTOR_HEAP_EXT"),
            (65536u64, "RESERVED_16_KHR"),
...
impl VideoEncodeFeedbackFlagsKHR {
    ...
    pub const RESERVED_3_KHR: Self = Self(0x8);
    pub const RESERVED_4_KHR: Self = Self(0x10);
    pub const RESERVED_5_KHR: Self = Self(0x20);
    pub const RESERVED_6_KHR: Self = Self(0x40);
    pub const RESERVED_7_KHR: Self = Self(0x80);
    pub const RESERVED_8_KHR: Self = Self(0x100);
    pub const RESERVED_9_KHR: Self = Self(0x200);
}
impl fmt::Display for VideoEncodeFeedbackFlagsKHR {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        const BITS: &[(u64, &str)] = &[
            ...
            (8u64, "RESERVED_3_KHR"),
            (16u64, "RESERVED_4_KHR"),
            (32u64, "RESERVED_5_KHR"),
            (64u64, "RESERVED_6_KHR"),
            (128u64, "RESERVED_7_KHR"),
            (256u64, "RESERVED_8_KHR"),
            (512u64, "RESERVED_9_KHR"),
        ];
        flag_display(self.0 as u64, BITS, f)
    }
}

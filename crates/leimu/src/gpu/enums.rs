...
impl FormatCompatibilityClass {  
    ...
    const CLASS_8_BIT: Self = Self::new(FormatType::Class8Bit);
    const CLASS_16_BIT: Self = Self::new(FormatType::Class16Bit);
    const CLASS_8_BIT_ALPHA: Self = Self::new(FormatType::Class8BitAlpha);
    const CLASS_24_BIT: Self = Self::new(FormatType::Class24Bit);
    const CLASS_32_BIT: Self = Self::new(FormatType::Class32Bit);
    const CLASS_48_BIT: Self = Self::new(FormatType::Class48Bit);
    const CLASS_64_BIT: Self = Self::new(FormatType::Class64Bit);
    const CLASS_96_BIT: Self = Self::new(FormatType::Class96Bit);
    const CLASS_128_BIT: Self = Self::new(FormatType::Class128Bit);
    const CLASS_192_BIT: Self = Self::new(FormatType::Class192Bit);
    const CLASS_256_BIT: Self = Self::new(FormatType::Class256Bit);
    const CLASS_D16: Self = Self::new(FormatType::ClassD16);
    const CLASS_D24: Self = Self::new(FormatType::ClassD24);
    const CLASS_D32: Self = Self::new(FormatType::ClassD32);
    const CLASS_S8: Self = Self::new(FormatType::ClassS8);
    const CLASS_D16S8: Self = Self::new(FormatType::ClassD16s8);
    const CLASS_D24S8: Self = Self::new(FormatType::ClassD24s8);
    const CLASS_D32S8: Self = Self::new(FormatType::ClassD32s8);
    const CLASS_BC1_RGB: Self = Self::new(FormatType::ClassBc1Rgb);
    const CLASS_BC1_RGBA: Self = Self::new(FormatType::ClassBc1Rgba);
    const CLASS_BC2: Self = Self::new(FormatType::ClassBc2);
    const CLASS_BC3: Self = Self::new(FormatType::ClassBc3);
    const CLASS_BC4: Self = Self::new(FormatType::ClassBc4);
    const CLASS_BC5: Self = Self::new(FormatType::ClassBc5);
    const CLASS_BC6H: Self = Self::new(FormatType::ClassBc6h);
    const CLASS_BC7: Self = Self::new(FormatType::ClassBc7);
    const CLASS_ETC2_RGB: Self = Self::new(FormatType::ClassEtc2Rgb);
    const CLASS_ETC2_RGBA: Self = Self::new(FormatType::ClassEtc2Rgba);
    const CLASS_ETC2_EAC_RGBA: Self = Self::new(FormatType::ClassEtc2EacRgba);
    const CLASS_EAC_R: Self = Self::new(FormatType::ClassEacR);
    const CLASS_EAC_RG: Self = Self::new(FormatType::ClassEacRG);
    const CLASS_ASTC_4X4: Self = Self::new(FormatType::ClassAstc4x4);
    const CLASS_ASTC_5X4: Self = Self::new(FormatType::ClassAstc5x4);
    const CLASS_ASTC_5X5: Self = Self::new(FormatType::ClassAstc5x5);
    const CLASS_ASTC_6X5: Self = Self::new(FormatType::ClassAstc6x5);
    const CLASS_ASTC_6X6: Self = Self::new(FormatType::ClassAstc6x6);
    const CLASS_ASTC_8X5: Self = Self::new(FormatType::ClassAstc8x5);
    const CLASS_ASTC_8X6: Self = Self::new(FormatType::ClassAstc8x6);
    const CLASS_ASTC_8X8: Self = Self::new(FormatType::ClassAstc8x8);
    const CLASS_ASTC_10X5: Self = Self::new(FormatType::ClassAstc10x5);
    const CLASS_ASTC_10X6: Self = Self::new(FormatType::ClassAstc10x6);
    const CLASS_ASTC_10X8: Self = Self::new(FormatType::ClassAstc10x8);
    const CLASS_ASTC_10X10: Self = Self::new(FormatType::ClassAstc10x10);
    const CLASS_ASTC_12X10: Self = Self::new(FormatType::ClassAstc12x10);
    const CLASS_ASTC_12X12: Self = Self::new(FormatType::ClassAstc12x12);
    const CLASS_32_BIT_G8B8G8R8: Self = Self::new(FormatType::Class32BitG8b8g8r8);
    const CLASS_32_BIT_B8G8R8G8: Self = Self::new(FormatType::Class32BitB8g8r8g8);
    const CLASS_8_BIT_3PLANE_420: Self = Self::new(FormatType::Class8Bit3Plane420);
    const CLASS_8_BIT_2PLANE_420: Self = Self::new(FormatType::Class8Bit2Plane420);
    const CLASS_8_BIT_3PLANE_422: Self = Self::new(FormatType::Class8Bit3Plane422);
    const CLASS_8_BIT_2PLANE_422: Self = Self::new(FormatType::Class8Bit2Plane422);
    const CLASS_8_BIT_3PLANE_444: Self = Self::new(FormatType::Class8Bit3Plane444);
    const CLASS_8_BIT_2PLANE_444: Self = Self::new(FormatType::Class8Bit2Plane444);
    const CLASS_64_BIT_R10G10B10A10: Self = Self::new(FormatType::Class64BitR10g10b10a10);
    const CLASS_64_BIT_G10B10G10R10: Self = Self::new(FormatType::Class64BitG10b10g10r10);
    const CLASS_64_BIT_B10G10R10G10: Self = Self::new(FormatType::Class64BitB10g10r10g10);
    const CLASS_10_BIT_3PLANE_420: Self = Self::new(FormatType::Class10Bit3Plane420);
    const CLASS_10_BIT_2PLANE_420: Self = Self::new(FormatType::Class10Bit2Plane420);
    const CLASS_10_BIT_3PLANE_422: Self = Self::new(FormatType::Class10Bit3Plane422);
    const CLASS_10_BIT_2PLANE_422: Self = Self::new(FormatType::Class10Bit2Plane422);
    const CLASS_10_BIT_3PLANE_444: Self = Self::new(FormatType::Class10Bit3Plane444);
    const CLASS_10_BIT_2PLANE_444: Self = Self::new(FormatType::Class10Bit2Plane444);
    const CLASS_64_BIT_R12G12B12A12: Self = Self::new(FormatType::Class64BitR12g12b12a12);
    const CLASS_64_BIT_G12B12G12R12: Self = Self::new(FormatType::Class64BitG12b12g12r12);
    const CLASS_64_BIT_B12G12R12G12: Self = Self::new(FormatType::Class64BitB12g12r12g12);
    const CLASS_12_BIT_3PLANE_420: Self = Self::new(FormatType::Class12Bit3Plane420);
    const CLASS_12_BIT_2PLANE_420: Self = Self::new(FormatType::Class12Bit2Plane420);
    const CLASS_12_BIT_3PLANE_422: Self = Self::new(FormatType::Class12Bit3Plane422);
    const CLASS_12_BIT_2PLANE_422: Self = Self::new(FormatType::Class12Bit2Plane422);
    const CLASS_12_BIT_3PLANE_444: Self = Self::new(FormatType::Class12Bit3Plane444);
    const CLASS_12_BIT_2PLANE_444: Self = Self::new(FormatType::Class12Bit2Plane444);
    const CLASS_64_BIT_G16B16G16R16: Self = Self::new(FormatType::Class64BitG16b16g16r16);
    const CLASS_64_BIT_B16G16R16G16: Self = Self::new(FormatType::Class64BitB16g16r16g16);
    const CLASS_16_BIT_3PLANE_420: Self = Self::new(FormatType::Class16Bit3Plane420);
    const CLASS_16_BIT_2PLANE_420: Self = Self::new(FormatType::Class16Bit2Plane420);
    const CLASS_16_BIT_3PLANE_422: Self = Self::new(FormatType::Class16Bit3Plane422);
    const CLASS_16_BIT_2PLANE_422: Self = Self::new(FormatType::Class16Bit2Plane422);
    const CLASS_16_BIT_3PLANE_444: Self = Self::new(FormatType::Class16Bit3Plane444);
    const CLASS_16_BIT_2PLANE_444: Self = Self::new(FormatType::Class16Bit2Plane444);
...
impl Format {
    ...
    pub const fn compatibility(self) -> FormatCompatibilityClass {
        if self.is_in_group_class_8bit() {
            FormatCompatibilityClass::CLASS_8_BIT
        } else if self.is_in_group_class_16bit() {
            FormatCompatibilityClass::CLASS_16_BIT
        } else if self.is_in_group_class_8bit_alpha() {
            FormatCompatibilityClass::CLASS_8_BIT_ALPHA
        } else if self.is_in_group_class_24bit() {
            FormatCompatibilityClass::CLASS_24_BIT
        } else if self.is_in_group_class_32bit() {
            FormatCompatibilityClass::CLASS_32_BIT
        } else if self.is_in_group_class_48bit() {
            FormatCompatibilityClass::CLASS_48_BIT
        } else if self.is_in_group_class_64bit() {
            FormatCompatibilityClass::CLASS_64_BIT
        } else if self.is_in_group_class_96bit() {
            FormatCompatibilityClass::CLASS_96_BIT
        } else if self.is_in_group_class_128bit() {
            FormatCompatibilityClass::CLASS_128_BIT
        } else if self.is_in_group_class_192bit() {
            FormatCompatibilityClass::CLASS_192_BIT
        } else if self.is_in_group_class_256bit() {
            FormatCompatibilityClass::CLASS_256_BIT
        } else if self.is_in_group_class_d16() {
            FormatCompatibilityClass::CLASS_D16
        } else if self.is_in_group_class_d24() {
            FormatCompatibilityClass::CLASS_D24
        } else if self.is_in_group_class_d32() {
            FormatCompatibilityClass::CLASS_D32
        } else if self.is_in_group_class_s8() {
            FormatCompatibilityClass::CLASS_S8
        } else if self.is_in_group_class_d16s8() {
            FormatCompatibilityClass::CLASS_D16S8
        } else if self.is_in_group_class_d24s8() {
            FormatCompatibilityClass::CLASS_D24S8
        } else if self.is_in_group_class_d32s8() {
            FormatCompatibilityClass::CLASS_D32S8
        } else if self.is_in_group_class_bc1_rgb() {
            FormatCompatibilityClass::CLASS_BC1_RGB
        } else if self.is_in_group_class_bc1_rgba() {
            FormatCompatibilityClass::CLASS_BC1_RGBA
        } else if self.is_in_group_class_bc2() {
            FormatCompatibilityClass::CLASS_BC2
        } else if self.is_in_group_class_bc3() {
            FormatCompatibilityClass::CLASS_BC3
        } else if self.is_in_group_class_bc4() {
            FormatCompatibilityClass::CLASS_BC4
        } else if self.is_in_group_class_bc5() {
            FormatCompatibilityClass::CLASS_BC5
        } else if self.is_in_group_class_bc6h() {
            FormatCompatibilityClass::CLASS_BC6H
        } else if self.is_in_group_class_bc7() {
            FormatCompatibilityClass::CLASS_BC7
        } else if self.is_in_group_class_etc2_rgb() {
            FormatCompatibilityClass::CLASS_ETC2_RGB
        } else if self.is_in_group_class_etc2_rgba() {
            FormatCompatibilityClass::CLASS_ETC2_RGBA
        } else if self.is_in_group_class_etc2_eac_rgba() {
            FormatCompatibilityClass::CLASS_ETC2_EAC_RGBA
        } else if self.is_in_group_class_eac_r() {
            FormatCompatibilityClass::CLASS_EAC_R
        } else if self.is_in_group_class_eac_r() {
            FormatCompatibilityClass::CLASS_EAC_RG
        } else if self.is_in_group_class_astc_4x4() {
            FormatCompatibilityClass::CLASS_ASTC_4X4
        } else if self.is_in_group_class_astc_5x4() {
            FormatCompatibilityClass::CLASS_ASTC_5X4
        } else if self.is_in_group_class_astc_5x5() {
            FormatCompatibilityClass::CLASS_ASTC_5X5
        } else if self.is_in_group_class_astc_6x5() {
            FormatCompatibilityClass::CLASS_ASTC_6X5
        } else if self.is_in_group_class_astc_6x6() {
            FormatCompatibilityClass::CLASS_ASTC_6X6
        } else if self.is_in_group_class_astc_8x5() {
            FormatCompatibilityClass::CLASS_ASTC_8X5
        } else if self.is_in_group_class_astc_8x6() {
            FormatCompatibilityClass::CLASS_ASTC_8X6
        } else if self.is_in_group_class_astc_8x8() {
            FormatCompatibilityClass::CLASS_ASTC_8X8
        } else if self.is_in_group_class_astc_10x5() {
            FormatCompatibilityClass::CLASS_ASTC_10X5
        } else if self.is_in_group_class_astc_10x6() {
            FormatCompatibilityClass::CLASS_ASTC_10X6
        } else if self.is_in_group_class_astc_10x8() {
            FormatCompatibilityClass::CLASS_ASTC_10X8
        } else if self.is_in_group_class_astc_10x10() {
            FormatCompatibilityClass::CLASS_ASTC_10X10
        } else if self.is_in_group_class_astc_12x10() {
            FormatCompatibilityClass::CLASS_ASTC_12X10
        } else if self.is_in_group_class_astc_12x12() {
            FormatCompatibilityClass::CLASS_ASTC_12X12
        } else if self.is_in_group_class_32bit_g8b8g8r8() {
            FormatCompatibilityClass::CLASS_32_BIT_G8B8G8R8
        } else if self.is_in_group_class_32bit_b8g8r8g8() {
            FormatCompatibilityClass::CLASS_32_BIT_B8G8R8G8
        } else if self.is_in_group_class_8bit_3plane_420() {
            FormatCompatibilityClass::CLASS_8_BIT_3PLANE_420
        } else if self.is_in_group_class_8bit_2plane_420() {
            FormatCompatibilityClass::CLASS_8_BIT_2PLANE_420
        } else if self.is_in_group_class_8bit_3plane_422() {
            FormatCompatibilityClass::CLASS_8_BIT_3PLANE_422
        } else if self.is_in_group_class_8bit_2plane_422() {
            FormatCompatibilityClass::CLASS_8_BIT_2PLANE_422
        } else if self.is_in_group_class_8bit_3plane_444() {
            FormatCompatibilityClass::CLASS_8_BIT_3PLANE_444
        } else if self.is_in_group_class_8bit_2plane_444() {
            FormatCompatibilityClass::CLASS_8_BIT_2PLANE_444
        } else if self.is_in_group_class_64bit_r10g10b10a10() {
            FormatCompatibilityClass::CLASS_64_BIT_R10G10B10A10
        } else if self.is_in_group_class_64bit_g10b10g10r10() {
            FormatCompatibilityClass::CLASS_64_BIT_G10B10G10R10
        } else if self.is_in_group_class_64bit_b10g10r10g10() {
            FormatCompatibilityClass::CLASS_64_BIT_B10G10R10G10
        } else if self.is_in_group_class_10bit_3plane_420() {
            FormatCompatibilityClass::CLASS_10_BIT_3PLANE_420
        } else if self.is_in_group_class_10bit_2plane_420() {
            FormatCompatibilityClass::CLASS_10_BIT_2PLANE_420
        } else if self.is_in_group_class_10bit_3plane_422() {
            FormatCompatibilityClass::CLASS_10_BIT_3PLANE_422
        } else if self.is_in_group_class_10bit_2plane_422() {
            FormatCompatibilityClass::CLASS_10_BIT_2PLANE_422
        } else if self.is_in_group_class_10bit_3plane_444() {
            FormatCompatibilityClass::CLASS_10_BIT_3PLANE_444
        } else if self.is_in_group_class_10bit_2plane_444() {
            FormatCompatibilityClass::CLASS_10_BIT_2PLANE_444
        } else if self.is_in_group_class_64bit_r12g12b12a12() {
            FormatCompatibilityClass::CLASS_64_BIT_R12G12B12A12
        } else if self.is_in_group_class_64bit_g12b12g12r12() {
            FormatCompatibilityClass::CLASS_64_BIT_G12B12G12R12
        } else if self.is_in_group_class_12bit_3plane_420() {
            FormatCompatibilityClass::CLASS_12_BIT_3PLANE_420
        } else if self.is_in_group_class_12bit_2plane_420() {
            FormatCompatibilityClass::CLASS_12_BIT_2PLANE_420
        } else if self.is_in_group_class_12bit_3plane_422() {
            FormatCompatibilityClass::CLASS_12_BIT_3PLANE_422
        } else if self.is_in_group_class_12bit_2plane_422() {
            FormatCompatibilityClass::CLASS_12_BIT_2PLANE_422
        } else if self.is_in_group_class_12bit_3plane_444() {
            FormatCompatibilityClass::CLASS_12_BIT_3PLANE_444
        } else if self.is_in_group_class_12bit_2plane_444() {
            FormatCompatibilityClass::CLASS_12_BIT_2PLANE_444
        } else if self.is_in_group_class_64bit_g16b16g16r16() {
            FormatCompatibilityClass::CLASS_64_BIT_G16B16G16R16
        } else if self.is_in_group_class_64bit_b16g16r16g16() {
            FormatCompatibilityClass::CLASS_64_BIT_B16G16R16G16
        } else if self.is_in_group_class_64bit_b12g12r12g12() {
            FormatCompatibilityClass::CLASS_64_BIT_B12G12R12G12
        } else if self.is_in_group_class_16bit_3plane_420() {
            FormatCompatibilityClass::CLASS_16_BIT_3PLANE_420
        } else if self.is_in_group_class_16bit_2plane_420() {
            FormatCompatibilityClass::CLASS_16_BIT_2PLANE_420
        } else if self.is_in_group_class_16bit_3plane_422() {
            FormatCompatibilityClass::CLASS_16_BIT_3PLANE_422
        } else if self.is_in_group_class_16bit_2plane_422() {
            FormatCompatibilityClass::CLASS_16_BIT_2PLANE_422
        } else if self.is_in_group_class_16bit_3plane_444() {
            FormatCompatibilityClass::CLASS_16_BIT_3PLANE_444
        } else if self.is_in_group_class_16bit_2plane_444() {
            FormatCompatibilityClass::CLASS_16_BIT_2PLANE_444
        } else {

...
macro_rules! ash_style_enum {
        ...
        impl core::fmt::Debug for $name {
            ...
            fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                if self.is_empty() {
                    ...
                    let mut iter = <$repr as nox_ash::mem::num::Integer>::bit_iter(self.0);
                    let bit = unsafe {
    ...
    {$(
        ...
        impl $name {
            ...
            ///
            /// # Safety
            /// For enums, this can result in invalid values.
            #[inline(always)]
...
macro_rules! ash_style_enum_internal {
    ($(
        $(#[doc = $doc:literal])*
        #[flags($repr:ty)]
        $(#[default = $default:expr])?
...
pub(crate) use ash_style_enum_internal;

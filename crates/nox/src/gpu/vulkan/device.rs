...
#[derive(Error)]
pub enum AllocateError<Alloc: LocalAlloc> {
    #[display("{0}")]
    VkError(#[from] #[source] vk::Result),
    #[display("{0}")]
    AllocError(#[source] Alloc::Error),
}
        ...
        if api_version >= vk::API_VERSION_1_4 {
            unsafe { Self {
                ...
                cmd_set_rendering_input_attachment_indices: load_fn!(
                    ...
                    vk::PFN_vkCmdSetRenderingInputAttachmentIndices<'_>,
                ),
...
///
/// A version of [`ash::Device`] with heavy modifications.
///
/// Designed for Nox use only.
///
/// Only exposes functions that are quaranteed to be usable with Nox.
#[derive(Clone)]
pub struct Device {
    handle: vk::Device,
    ash_device: nox_ash::Device,
...
impl Device {
    ...
    pub(super) fn new(
        ...
        physical_device_info: &PhysicalDeviceInfo<'_>,
    ) -> Self {
        let handle = device.handle();
        let api_version = physical_device_info.api_version().as_u32();
        Self {
            handle,
            ash_device: device,
    ...
    #[inline(always)]
    pub fn fp_v1_0(&self) -> &nox_ash::DeviceFnV1_0 {
        self.ash_device.fp_v1_0()
    }

    /// Raw Vulkan 1.1 functions.
    #[inline(always)]
    pub fn fp_v1_1(&self) -> &nox_ash::DeviceFnV1_1 {
        self.ash_device.fp_v1_1()
    }
    ...
    #[inline(always)]
    pub(crate) fn ash_device(&self) -> &nox_ash::Device {
        &self.ash_device
    }
    
    /// Gets the raw [`vk::Device`] handle.
    #[inline(always)]
    ...
    pub(super) unsafe fn destroy_device(
        &self,
    ...
    pub unsafe fn queue_wait_idle(
        ...
        unsafe {
            (self.fp_v1_0().queue_wait_idle)(queue)
        }.result()
    }
    ...
    pub unsafe fn device_wait_idle(
        ...
        unsafe {
            ((self.fp_v1_0().device_wait_idle)(self.handle))
        }.result()
    }
    ...
    pub unsafe fn flush_mapped_memory_ranges(
        ...
        unsafe {
            (self.fp_v1_0().flush_mapped_memory_ranges)(
                self.handle,
    ...
    pub unsafe fn invalidate_mapped_memory_ranges(
        ...
        unsafe {
            (self.fp_v1_0().invalidate_mapped_memory_ranges)(
                self.handle,
                memory_ranges.len() as u32,
                memory_ranges.as_ptr(),
            )
    ...
    pub unsafe fn get_device_memory_commitment(
        ...
        unsafe {
            (self.fp_v1_0().get_device_memory_commitment)(
                self.handle,
                memory,
    ...
    pub unsafe fn bind_buffer_memory(
        ...
        unsafe {
            (self.fp_v1_0().bind_buffer_memory)(
                self.handle,
                buffer,
                memory,
                memory_offset,
    ...
    pub unsafe fn bind_image_memory(
        ...
        unsafe {
            (self.fp_v1_0().bind_image_memory)(
                self.handle,
                image,
                memory,
                memory_offset,
    ...
    pub unsafe fn queue_bind_sparse(
        ...
        unsafe {
            (self.fp_v1_0().queue_bind_sparse)(
                queue,
    ...
    pub unsafe fn create_query_pool(
        ...
        unsafe {
            (self.fp_v1_0().create_query_pool)(
                self.handle,
                create_info,
                allocator.as_ptr(),
                &mut query_pool,
    ...
    pub unsafe fn get_query_pool_results(
        ...
        unsafe {
            (self.fp_v1_0().get_query_pool_results)(
                self.handle,
                query_pool,
                first_query,
                query_count,
    ...
    pub unsafe fn create_buffer_view(
        ...
        unsafe {
            (self.fp_v1_0().create_buffer_view)(
                self.handle,
                create_info,
                allocator.as_ptr(),
                &mut buffer_view,
    ...
    pub unsafe fn create_image_view(
        ...
        unsafe {
            (self.fp_v1_0().create_image_view)(
                self.handle,
                create_info,
                allocator.as_ptr(),
                &mut image_view,
    ...
    pub unsafe fn create_shader_module(
        ...
        unsafe {
            (self.fp_v1_0().create_shader_module)(
                self.handle,
                create_info,
                allocator.as_ptr(),
                &mut shader_module,
    ...
    pub unsafe fn create_pipeline_cache(
        ...
        unsafe {
            (self.fp_v1_0().create_pipeline_cache)(
                self.handle,
                create_info,
                allocator.as_ptr(),
                &mut pipeline_cache,
    ...
    ///
    /// If you want to allocate the buffer yourself, use [`Device::fp_v1_0`].get_pipeline_cache_data.
    ///
    /// # Safety
    /// All raw Vulkan calls are inherently unsafe, because no validation of input or usage is applied.
    #[inline(always)]
    pub unsafe fn get_pipeline_cache_data(
        ...
        unsafe {
            let mut data_size = 0;
            (self.fp_v1_0().get_pipeline_cache_data)(
                self.handle,
                pipeline_cache,
                &mut data_size,
                ptr::null_mut(),
    ...
    pub unsafe fn merge_pipeline_caches(
        ...
        unsafe {
            (self.fp_v1_0().merge_pipeline_caches)(
                self.handle,
                dst_cache,
    ...
    pub unsafe fn create_compute_pipelines(
        ...
        unsafe {
            (self.fp_v1_0().create_compute_pipelines)(
                self.handle,
                pipeline_cache,
                create_infos.len() as u32,
                create_infos.as_ptr(),
    ...
    pub unsafe fn create_pipeline_layout(
        ...
        unsafe {
            (self.fp_v1_0().create_pipeline_layout)(
                self.handle,
                create_info,
                allocator.as_ptr(),
                &mut pipeline_layout,
    ...
    pub unsafe fn create_descriptor_set_layout(
        ...
        unsafe {
            (self.fp_v1_0().create_descriptor_set_layout)(
                self.handle,
                create_info,
                allocator.as_ptr(),
                &mut set_layout,
    ...
    pub unsafe fn create_descriptor_pool(
        ...
        unsafe {
            (self.fp_v1_0().create_descriptor_pool)(
                self.handle,
                create_info,
                allocator.as_ptr(),
                &mut descriptor_pool,
    ...
    pub unsafe fn reset_descriptor_pool(
        ...
        unsafe {
            (self.fp_v1_0().reset_descriptor_pool)(
                self.handle,
                descriptor_pool,
                flags,
            )
    ...
    pub unsafe fn create_command_pool(
        ...
        unsafe {
            (self.fp_v1_0().create_command_pool)(
                self.handle,
                create_info,
                allocator.as_ptr(),
                &mut command_pool,
    ...
    pub unsafe fn reset_command_pool(
        ...
        unsafe {
            (self.fp_v1_0().reset_command_pool)(
                self.handle,
                command_pool,
                flags,
            )
    ...
    pub unsafe fn begin_command_buffer(
        ...
        unsafe {
            (self.fp_v1_0().begin_command_buffer)(
                command_buffer,
                begin_info,
            )
        }.result()
    ...
    pub unsafe fn end_command_buffer(
        ...
        unsafe {
            (self.fp_v1_0().end_command_buffer)(
                command_buffer,
            )
        }.result()
    }
    ...
    pub unsafe fn reset_command_buffer(
        ...
        unsafe {
            (self.fp_v1_0().reset_command_buffer)(
                command_buffer,
                flags,
            )
        }.result()
    ...
    pub unsafe fn cmd_set_depth_bounds(
        ...
        unsafe {
            (self.fp_v1_0().cmd_set_depth_bounds)(
                command_buffer,
                min_depth_bounds,
                max_depth_bounds,
            )
    ...
    pub unsafe fn cmd_set_stencil_compare_mask(
        ...
        unsafe {
            (self.fp_v1_0().cmd_set_stencil_compare_mask)(
                command_buffer,
                face_mask,
                compare_mask,
            )
    ...
    pub unsafe fn cmd_set_stencil_write_mask(
        ...
        unsafe {
            (self.fp_v1_0().cmd_set_stencil_write_mask)(
                command_buffer,
                face_mask,
                write_mask,
            )
    ...
    /// See also [`Device::cmd_bind_descriptor_sets2`].
    ///
    /// Part of Vulkan 1.0 core.
    ///
    ...
    /// See also [`Device::cmd_bind_index_buffer2`].
    ///
    /// Part of Vulkan 1.0 core.
    ///
    ...
    /// See also [`Device::cmd_bind_vertex_buffers2`].
    ///
    /// Part of Vulkan 1.0 core.
    ///
    ...
    pub unsafe fn bind_image_memory2(
        ...
        unsafe {
            (self.fp_v1_1().bind_image_memory2)(
                self.handle,
                bind_infos.len() as u32,
                bind_infos.as_ptr(),
            )
    ...
    /// `vkGetBufferMemoryRequirements`, you can find it in [`Device::fp_v1_0`].
    ///
    /// # See also
    /// - [`Device::get_device_buffer_memory_requirements`] for a version that doesn't require a
    ///   buffer handle.
    /// # Safety
    /// All raw Vulkan calls are inherently unsafe, because no validation of input or usage is applied.
    #[inline(always)]
    ...
    /// prefer this one because it can get you more information about the requirements (see
    /// [`vk::MemoryDedicatedRequirements`]). If you still want to use
    /// `vkGetImageMemoryRequirements`, you can find it in [`Device::fp_v1_0`].
    ///
    /// # See also
    /// - [`Device::get_device_image_memory_requirements`] for a version that doesn't require an
    ///   image handle.
    /// # Safety
    /// All raw Vulkan calls are inherently unsafe, because no validation of input or usage is applied.
    #[inline(always)]
    ...
    /// `vkGetImageSparseMemoryRequirements`, you can find it in [`Device::fp_v1_0`].
    //
    /// # See also
    /// - [`Device::get_device_image_sparse_memory_requirements`] for a version that doesn't require
    ///   an image handle.
    ///
    /// # Safety
    /// All raw Vulkan calls are inherently unsafe, because no validation of input or usage is applied.
    ...
    /// Part of Vulkan 1.1 core.
    ///
    /// To get the number of requirements to allocate, use
    /// [`Device::get_image_sparse_memory_requirements2_len`].
    ///
    /// If you are looking for [`get_image_sparse_memory_requirements`] (without 2), you should
    /// prefer this one because it's more future-proof. If you still want to use
    /// `vkGetImageSparseMemoryRequirements`, you can find it in [`Device::fp_v1_0`].
    ...
    pub unsafe fn get_device_queue2(
        ...
        let mut queue = vk::Queue::null();
        unsafe {
            (self.fp_v1_1().get_device_queue2)(
                self.handle,
                queue_info,
                &mut queue,
            )
    ...
    pub unsafe fn create_sampler_ycbcr_conversion(
        ...
        unsafe {
            (self.fp_v1_1().create_sampler_ycbcr_conversion)(
                self.handle,
                create_info,
                allocator.as_ptr(),
    ...
    pub unsafe fn create_descriptor_update_template(
        ...
        unsafe {
            (self.fp_v1_1().create_descriptor_update_template)(
                self.handle,
                create_info,
                allocator.as_ptr(),
    ...
    pub unsafe fn get_semaphore_counter_value(
        ...
        let mut value = 0;
        unsafe {
            (self.fp_v1_2().get_semaphore_counter_value)(
                self.handle,
                semaphore,
                &mut value,
            )
    ...
    pub unsafe fn cmd_end_rendering(
        ...
        unsafe {
            (self.fp_v1_3().cmd_end_rendering)(
                command_buffer,
            )
        }
    }
    ...
    pub unsafe fn cmd_set_cull_mode(
        ...
        unsafe {
            (self.fp_v1_3().cmd_set_cull_mode)(
                command_buffer,
                cull_mode,
            )
        }
    ...
    pub unsafe fn cmd_set_depth_compare_op(
        ...
        unsafe {
            (self.fp_v1_3().cmd_set_depth_compare_op)(
                command_buffer,
                depth_compare_op,
            )
        }
    ...
    pub unsafe fn cmd_set_depth_test_enable(
        ...
        unsafe {
            (self.fp_v1_3().cmd_set_depth_test_enable)(
                command_buffer,
    ...
    pub unsafe fn cmd_set_depth_write_enable(
        ...
        unsafe {
            (self.fp_v1_3().cmd_set_depth_write_enable)(
                command_buffer,
    ...
    pub unsafe fn cmd_set_front_face(
        ...
        unsafe {
            (self.fp_v1_3().cmd_set_front_face)(
                command_buffer,
                front_face,
            )
        }
    ...
    pub unsafe fn cmd_set_primitive_topology(
        ...
        unsafe {
            (self.fp_v1_3().cmd_set_primitive_topology)(
                command_buffer,
                primitive_topology,
            )
        }
    ...
    pub unsafe fn cmd_set_stencil_test_enable(
        ...
        unsafe {
            (self.fp_v1_3().cmd_set_stencil_test_enable)(
                command_buffer,
    ...
    pub unsafe fn cmd_copy_buffer_to_image2(
        ...
        unsafe {
            (self.fp_v1_3().cmd_copy_buffer_to_image2)(
                command_buffer,
    ...
    pub unsafe fn cmd_copy_image_to_buffer2(
        ...
        unsafe {
            (self.fp_v1_3().cmd_copy_image_to_buffer2)(
                command_buffer,
    ...
    pub unsafe fn cmd_resolve_image2(
        ...
        unsafe {
            (self.fp_v1_3().cmd_resolve_image2)(
                command_buffer,
                resolve_image_info,
            )
        }
    ...
    pub unsafe fn cmd_pipeline_barrier2(
        ...
        unsafe {
            (self.fp_v1_3().cmd_pipeline_barrier2)(
                command_buffer,
                dependency_info,
            )
        }
    ...
    /// Part of Vulkan 1.3 core, otherwise provided by VK_KHR_synchronization2 device extension.
    ///
    /// If you are looking for `queue_submit` (without 2), you should prefer this one because it
    /// gives more explicit control over semaphores. If you still want to use `vkQueueSubmit`, you
    /// can find it in [`Device::fp_v1_0`].
    /// # Safety
    /// All raw Vulkan calls are inherently unsafe, because no validation of input or usage is applied.
    #[inline(always)]
    ...
    pub unsafe fn get_device_buffer_memory_requirements(
        ...
        unsafe {
            (self.fp_v1_3().get_device_buffer_memory_requirements)(
                self.handle,
                info,
                memory_requirements,
            )
    ...
    pub unsafe fn get_device_image_memory_requirements(
        ...
        unsafe {
            (self.fp_v1_3().get_device_image_memory_requirements)(
                self.handle,
                info,
                memory_requirements,
            )
    ...
    /// All raw Vulkan calls are inherently unsafe, because no validation of input or usage is applied.
    #[inline(always)]
    pub unsafe fn get_device_image_sparse_memory_requirements_len<'a>(
        &self,
        info: &vk::DeviceImageMemoryRequirements<'_>,
    ) -> u32 {
        let mut sparse_memory_requirement_count = 0;
    ...
    ///
    /// To get the number of requirements to allocate, use
    /// [`Device::get_device_image_sparse_memory_requirements_len`].
    ///
    /// Part of Vulkan 1.3 core, otherwise provided by VK_KHR_maintenance4 device extension.
    /// # Safety
    /// All raw Vulkan calls are inherently unsafe, because no validation of input or usage is applied.
    ...
    pub unsafe fn cmd_set_rendering_attachment_locations(
        ...
        unsafe {
            (self.fp_v1_4().cmd_set_rendering_attachment_locations)(
                command_buffer,
                location_info,
            )
        }
    ...
    pub unsafe fn cmd_set_rendering_input_attachment_indices(
        ...
        unsafe {
            (self.fp_v1_4().cmd_set_rendering_input_attachment_indices)(
                command_buffer,
    ...
    pub unsafe fn cmd_bind_index_buffer2(
        ...
        unsafe {
            (self.fp_v1_4().cmd_bind_index_buffer2)(
                command_buffer,
                buffer,
                offset,
                size,
    ...
    pub unsafe fn cmd_bind_descriptor_sets2(
        ...
        unsafe {
            (self.fp_v1_4().cmd_bind_descriptor_sets2)(
                command_buffer,
    ...
    pub unsafe fn cmd_push_constants2(
        ...
        unsafe {
            (self.fp_v1_4().cmd_push_constants2)(
                command_buffer,
                push_constants_info,
            )
        }

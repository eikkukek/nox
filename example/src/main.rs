...
struct Data {
    ...
    cube_shader_set: gpu::ShaderSetId,
    outline_shader_set: gpu::ShaderSetId,
    fire_effect_compute_shader_set: gpu::ShaderSetId,
    fire_effect_shader_set: gpu::ShaderSetId,
    cube_pipeline: gpu::GraphicsPipelineId,
    outline_pipeline: gpu::GraphicsPipelineId,
